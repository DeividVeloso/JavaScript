    ...
    _createClass(NegociacaoDao, [{
        ...
        value: function adiciona(negociacao) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                request.onsuccess = function (e) {
                    console.log(_this._store + ' Inserido com sucesso');
                    resolve(); // Retornando a Promise resolvida sem dados
                };

                request.onerror = function (e) {
                    console.log(e.target.error);
                    reject('Erro ao inserir ' + _this._store);
                };
            });
        }
    }, {
        ...
        value: function listaTodos() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var cursor = _this2._connection.transaction([_this2._store], 'readwrite') //Pega a conexão com o IndexDB e pede permissão de escrita e leitura nessa tabela
                .objectStore(_this2._store) //Pega tabela(StoreObject) negociacoes
        ...
        value: function apagaTodos() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var request = _this3._connection.transaction([_this3._store], 'readwrite').objectStore(_this3._store).clear(); //Apaga a minha obejectStore
